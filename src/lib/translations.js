...
export default {
	...
	fr: {
		banner: {
			title:
				'Les cookies nous aident à vous délivrer un service de qualité.',
			description:
		...
		summary: {
			...
			what: {
				...
				description:
					'Chaque partenaire utilise différemment vos données.',
		...
		purposes: {
			...
			description:
				'Ci-dessous la liste des données pouvant être collectées :',
	...
	de: {
		...
		summary: {
			...
			what: {
				...
				description:
					'Jeder Partner verwendet Ihre Daten unterschiedlich.',
	...
	pl: {
		...
		purposes: {
			title: 'Jakie informacje mogą być używane?',
			description:
				'Poniżej znajduje się pełna lista informacji, jakie mogą być gromadzone.',
			back:
				'Dostosuj sposób, w jaki dane z poprzedniej strony są używane',
		...
		vendors: {
			...
			back:
				'Dostosuj sposób, w jaki te firmy korzystają z danych z poprzedniej strony'
		}
	},
	it: {
		banner: {
